...
export default function Signup() {
	...
	return (
		<div className="mt-40 w-full h-full z-50 bg-white shadow">
							...
							<form onSubmit={onSubmit} className="space-y-4 md:space-y-6">
								...
								<div>
									...
									<input
										...
										id="confirm-password"
										placeholder="••••••••"
										className={`bg-gray-50 border ${feedback ? 'border-red-500' : 'border-gray-300'} text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
										required
									/>
								</div>
