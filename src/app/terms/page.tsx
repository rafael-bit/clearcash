export default function Terms() {
	return (
		<main className="p-6 max-w-4xl mx-auto">
			<h1 className="text-2xl pb-10">Terms and Conditions</h1>
			<p>Welcome to the Terms of Service and Privacy Policy of ClearCash, a financial control app developed by ClearCash. By using the services provided by this app, you agree to the following terms and policies. Please read carefully before using our services.</p>

			<h1 className="text-lg p-4"><b>Terms of Service</b></h1>
