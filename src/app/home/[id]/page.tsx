		...
		<div className="antialiased bg-gray-50 dark:bg-gray-900">
			...
			<main className="p-4 md:ml-64 h-auto pt-20">
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mb-4">
					<div className="border border-gray-200 dark:border-gray-600 shadow bg-gray-100 dark:bg-gray-800 rounded-lg h-40 md:h-56 p-7 hover:bg-gray-200 dark:hover:bg-gray-700 ">
						<h1 className="text-gray-600 dark:text-gray-200 flex justify-between items-center text-2xl font-bold">
							Income
